...
public class FileInfo implements Cloneable {
	...
	/* File format (TIFF, GIF_OR_JPG, BMP, etc.). 
         Used by the File/Revert command */
	...
	/** Creates a FileInfo object with all of its fields set to their 
         * default value. */
     public FileInfo() {
	...
	public int getBytesPerPixel() {
		switch (fileType) {
			...
			case GRAY32_INT: case GRAY32_UNSIGNED: 
                        case GRAY32_FLOAT: 
                        case ARGB: case GRAY24_UNSIGNED: case BARG: return 4;
    ...
    public String toString() {
    	return
			...
			+ ", lutSize=" + lutSize
			+ ", comp=" + compression
			+ ", ranges=" + (displayRanges!=null?""
                        +displayRanges.length/2:"null")
