...
public class LocalThresholdAdjuster extends PlugInFrame implements PlugIn, Measurements,
...
class ThresholdPlot extends Canvas implements Measurements, MouseListener {
	...
	public void paint(Graphics g) {
		...
		g.setColor(Color.black);
 		...
 		if (mode==LocalThresholdAdjuster.RED)
			g.setColor(Color.red);
		else if (mode==LocalThresholdAdjuster.OVER_UNDER) {
