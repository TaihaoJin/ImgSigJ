 ...
 * 
*** modified 6/22/2008 by Taihao Jin, when spliting a stack of N*M slice into N stacks of M slices, 
 * instead of including M consecutive slices into each stack, including one every N slices. 
...
//		{
		...
		{	//tj
            ...
            // Populate this stack.
			//for (int n = 1; n <= numImages; ++n, ++index)
			//{      // RWC
			for (int n = 1; n <= numImages; ++n)
			{      // TJ
				index=nss+(n-1)*numSubStacks;
