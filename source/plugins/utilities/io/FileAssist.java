...
//        FileSystemView fsv=FileSystemView.getFileSystemView();
    ...
    public static File[] getMultipleFiles(String sTitle, String sDefaultDirectory,ArrayList<String> sFileTypes, ArrayList<String> sExts,boolean bOpening){
        String path;
        int nType;
        if(bOpening){
            nType=JFileChooser.OPEN_DIALOG;
...
//        FileSystemView fsv=FileSystemView.getFileSystemView();
        if(sDefaultDirectory.equals("")){
            if(defaultDirectory==null)defaultDirectory="\\C:";
            sDefaultDirectory=defaultDirectory;
        }
        JFileChooser jfc=CommonGuiMethods.openFileDialogExtFilter(sTitle, nType, sFileTypes, sExts, sDefaultDirectory,true);
        path=jfc.getSelectedFile().getAbsolutePath();
