...
public class CommonGuiMethods {
    ...
    public static JFileChooser openFileDialogExtFilter(String sTitle,int type, ArrayList<String> sFileTypes, ArrayList<String> sExts, String sDir){
        return openFileDialogExtFilter(sTitle,type, sFileTypes, sExts, sDir, false);
    }
    public static JFileChooser openFileDialogExtFilter(String sTitle,int type, ArrayList<String> sFileTypes, ArrayList<String> sExts, String sDir, boolean multipleSelection){//type=JFileChooser.OPEN_DIALOG or JFileChooser.SAVE_DIALOG
            JFileChooser chooser = new JFileChooser();
...
//        IMap.put(stroke,actionName);
    ...
    public static int makeClipboardCopiable(JDialog frame){
        if(frame==null) return -1;
